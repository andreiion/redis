...
RUN apt-get update && apt-get install -y apt-utils less vim htop iproute2 iputils-ping tcpdump iproute2 iperf3 linux-headers-$(uname -r) linux-tools-$(uname -r) bpfcc-tools build-essential sysstat
